          ...
          <>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 mb-6">
              <div className="mb-3">
                ...
                <Link
                  href="/auth/signup"
                  className="w-full mt-3 px-4 py-2 bg-primary-800 text-white text-sm font-medium rounded-lg hover:bg-primary-900 transition flex items-center justify-between"
                >
